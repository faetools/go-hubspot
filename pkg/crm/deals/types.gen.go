...
// GetPageDealsParams defines parameters for GetPageDeals.
type GetPageDealsParams struct {
...
// CreateDealsJSONBody defines parameters for CreateDeals.
type CreateDealsJSONBody SimplePublicObjectInput
...
// GetByIdDealParams defines parameters for GetByIdDeal.
type GetByIdDealParams struct {
	// A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
	Properties *[]string `json:"properties,omitempty"`
...
type UpdateDealJSONBody SimplePublicObjectInput
...
// CreateDealsJSONRequestBody defines body for CreateDeals for application/json ContentType.
type CreateDealsJSONRequestBody CreateDealsJSONBody
