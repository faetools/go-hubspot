...
// CreateLineItemsJSONBody defines parameters for CreateLineItems.
type CreateLineItemsJSONBody SimplePublicObjectInput
...
// GetByIdLineItemParams defines parameters for GetByIdLineItem.
type GetByIdLineItemParams struct {
	// A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored.
	Properties *[]string `json:"properties,omitempty"`
...
type UpdateLineItemJSONBody SimplePublicObjectInput
...
// CreateLineItemsJSONRequestBody defines body for CreateLineItems for application/json ContentType.
type CreateLineItemsJSONRequestBody CreateLineItemsJSONBody
