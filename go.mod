module github.com/faetools/go-hubspot

go 1.17

require (
	github.com/deepmap/oapi-codegen v1.9.1
	github.com/faetools/client v0.0.0-20220127180657-223442d25e45
	github.com/faetools/devtool v0.0.0-20220123204838-8ae48c447da6
